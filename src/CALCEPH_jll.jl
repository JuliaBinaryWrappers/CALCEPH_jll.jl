...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CALCEPH_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("dd3044d3-6c85-52eb-b239-9fbeaa51d7ac"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CALCEPH", artifacts_toml) for e in artifacts["CALCEPH"]]
...
if best_platform === nothing
    @debug("Unable to load CALCEPH; unsupported platform $(triplet(platform_key_abi()))")
else
